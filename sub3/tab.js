...
//    $('.sub2_tab ul li').css('background','#fff').css('color','#333');

    // $('.sub2_tab ul li:eq('+ind+')').css('background','#bd0202'); //모든 탭내용을 안보이게...
    // $('.sub2_tab ul li:eq('+ind+')').css('color','#fff'); //모든 탭내용을 안보이게...

    $('.sub2_tab ul li').removeClass('current');
    $('.sub2_tab ul li:eq('+ind+')').addClass('current');
