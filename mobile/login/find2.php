  ...
  */
  ...
  암호화된 pass가 입력된 pass의 암호화와 일치하는가를 확인해야함*/
        ...
        function generateRandomPassword($length=8, $strength=0) {
            $vowels = 'aeuy';
            $consonants = 'bdg1hjmn3pqrstvz456';  //랜덤으로 뽑아낼 기본 문자
            if ($strength & 1) {
                $consonants .= 'B345DGHJ@LM$NPQ#R!STVWX0126789Z';  //추가할 문자
            }
        ...
        echo " <strong>[ 가입정보 ]</strong><br>
           임시 비밀번호는 <strong> $ranpass </strong> 입니다<br>
