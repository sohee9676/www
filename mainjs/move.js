...
$(document).ready(function() {
    ...
    //  }
     ...
     $('.gallery .link'+cnt).fadeIn('slow'); //자신만 이미지가 보인다..
      ...
      $('.btn'+cnt).css('background','#bd0202') //자신만 불 켜
      $('.btn'+cnt).css('width','25');    

      $('.gallery li span').css('top',330).css('opacity',0);
      $('.gallery .link'+cnt).find('span').delay(800).animate({top:500, opacity:1},'slow');
   ...
   $('.mbutton').click(function(event){  //각각의 버튼 클릭시
      ...
      $('.btn'+cnt).css('background','#bd0202');//자신 버튼만 불켜 
      $('.btn'+cnt).css('width','25');
   ...
   $('.ps').click(function(){ 
    ...
    $('.gallery li span').css('top',340).css('opacity',0);
